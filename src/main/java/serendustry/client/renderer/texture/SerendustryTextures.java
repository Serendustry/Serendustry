...
public class SerendustryTextures {
    ...
    public static void preInit() {
        ...
        CASING_ACR = new SimpleOverlayRenderer("casing/serendustry_multi/acr");
        CASING_SPACE_ELEVATOR = new SimpleOverlayRenderer("casing/serendustry_multi/space_elevator");

        TEXTURE_ADV_FUSION = new SimpleOverlayRenderer("casing/serendustry_multi/adv_fusion");
        TEXTURE_ADV_FUSION_ACTIVE = new SimpleOverlayRenderer("casing/serendustry_multi/adv_fusion_active");

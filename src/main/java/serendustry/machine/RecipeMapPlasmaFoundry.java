...
public class RecipeMapPlasmaFoundry extends
    ...
    private final Object2IntMap<ItemStack> catalysts = new Object2IntOpenCustomHashMap<>(
            ItemStackHashStrategy.builder().compareItem(true).compareDamage(true).build());

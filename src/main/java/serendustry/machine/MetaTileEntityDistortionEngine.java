...
public class MetaTileEntityDistortionEngine extends RecipeMapMultiblockController {
    ...
    public MetaTileEntityDistortionEngine(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, SerendustryRecipeMaps.DISTORTION_ENGINE_RECIPES);
        this.recipeMapWorkable = new MultiblockRecipeLogic(this, true);
    }

    @Override
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity iGregTechTileEntity) {
        return new MetaTileEntityDistortionEngine(metaTileEntityId);
    }

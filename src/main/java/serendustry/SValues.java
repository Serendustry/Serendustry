...
public class SValues {
    ...
    public static final Material[] TIER_PLATE = { WroughtIron, Steel, Aluminium, StainlessSteel, Titanium,
            ...
            AwakenedDraconium, Quantum, Floppa };
    public static final Material[] TIER_CABLE = { RedAlloy, Tin, Copper, Gold, Aluminium, Platinum, NiobiumTitanium,
            VanadiumGallium, YttriumBariumCuprate, Europium, Quantium40, Hypogen, Bedrockium, Quantium, Floppa };
    ...
    public static final Material[] TIER_SUPERCONDUCTOR = { Floppa, ManganesePhosphide, MagnesiumDiboride,
            ...
            ScUevSane, ScUiv, ScUxv, ScOpv, Floppa };
    ...
    public static final MetaItem.MetaValueItem[] TIER_POWER_IC = { ERROR_INGOT, ERROR_INGOT,
            ...
            HIGH_POWER_INTEGRATED_CIRCUIT, ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT, ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT,
            ULTRA_HIGH_POWER_INTEGRATED_CIRCUIT, CHIP_OPIC, CHIP_OPIC, CHIP_OPIC, CHIP_OPIC, CHIP_OPIC };
    public static final MetaItem.MetaValueItem[] TIER_PUMP = { ERROR_INGOT, ELECTRIC_PUMP_LV, ELECTRIC_PUMP_MV,
            ...
            ELECTRIC_PUMP_UV,
            ELECTRIC_PUMP_UHV, ELECTRIC_PUMP_UEV, ELECTRIC_PUMP_UIV, ELECTRIC_PUMP_UXV, ELECTRIC_PUMP_OpV,
            ELECTRIC_PUMP_MAX };
    public static final MetaItem.MetaValueItem[] TIER_SENSOR = { ERROR_INGOT, SENSOR_LV, SENSOR_MV, SENSOR_HV,
            SENSOR_EV, SENSOR_IV, SENSOR_LuV, SENSOR_ZPM, SENSOR_UV,
    ...
    public static final MetaItem.MetaValueItem[] TIER_EMITTER = { ERROR_INGOT, EMITTER_LV, EMITTER_MV, EMITTER_HV,
            EMITTER_EV, EMITTER_IV, EMITTER_LuV, EMITTER_ZPM, EMITTER_UV,
    ...
    public static final Material[] TIER_LUBRICANT = { Lubricant, Lubricant, Lubricant, Lubricant, Lubricant, Lubricant,
            MolybdeniteLubricant, MolybdeniteLubricant, Ferrofluid, Ferrofluid, Ferrofluid, OmniversalLubricant,
    ...
    // String formatting codes
      public static final STooltipHelper.SFormatCode FORMAT_ENVOIDIA = STooltipHelper.createNewCode(8, new TextFormatting[] {LIGHT_PURPLE}, new TextFormatting[] {AQUA}, new TextFormatting[] {WHITE, OBFUSCATED}, new TextFormatting[] {RESET, AQUA}, new TextFormatting[] {LIGHT_PURPLE});


    //public static final TooltipHelper.GTFormatCode FORMAT_ENVOIDIA = TooltipHelper.createNewCode(10, LIGHT_PURPLE, AQUA, WHITE, AQUA, LIGHT_PURPLE);
}

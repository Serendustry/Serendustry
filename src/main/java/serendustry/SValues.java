...
public class SValues {
    ...
    public static final MetaItem.MetaValueItem[] Tier_PowerIC = { ERROR_INGOT, ERROR_INGOT,
    ...
    public static final Material[] Tier_Lube = { Lubricant, Lubricant, Lubricant, Lubricant, Lubricant, Lubricant,
    ...
    public static final Material[] Tier_MarkerMaterial = { MarkerMaterials.Tier.ULV, MarkerMaterials.Tier.LV,
    ...
    public static final MetaItem.MetaValueItem[] Tier_AnyCircuit = { CIRCUIT_ANY_ULV, CIRCUIT_ANY_LV, CIRCUIT_ANY_MV,
